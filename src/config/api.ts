export const API_CONFIG = {
  DDRAGON_VERSION: import.meta.env.VITE_DDRAGON_VERSION || '14.1.1',
  ...
  getChampionImageUrl: (championKey: string) => {
    return `${import.meta.env.VITE_DDRAGON_BASE_URL || 'https://ddragon.leagueoflegends.com'}/cdn/${import.meta.env.VITE_DDRAGON_VERSION || '14.1.1'}/img/champion/${championKey}.png`;
  },
